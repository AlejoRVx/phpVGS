    ...
    <div class="bg-gray-800 rounded-lg shadow-lg p-6 sm:p-8">
        <form action="{{ route('admin.noticias.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="titulo" name="titulo" value="{{ old('titulo') }}" class="w-full px-4 py-2 bg-gray-700 text-white rounded border border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-400" required>
            </div>

            <div class="mb-4">
                <label for="resumen" class="block text-gray-300 font-semibold mb-2">Resumen *</label>
                <textarea id="resumen" name="resumen" rows="2" class="w-full px-4 py-2 bg-gray-700 text-white rounded border border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-400" required>{{ old('resumen') }}</textarea>
            </div>
            ...
            <div class="mb-4">
                ...
                <select id="categoria" name="categoria" class="w-full px-4 py-2 bg-gray-700 text-white rounded border border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-400" required>
                    ...
                    <option value="Lanzamientos" {{ old('categoria') === 'Lanzamientos' ? 'selected' : '' }}>Lanzamientos</option>
            ...
            <div class="mb-6">
                ...
                <input type="url" id="enlace" name="enlace" value="{{ old('enlace') }}" class="w-full px-4 py-2 bg-gray-700 text-white rounded border border-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-400">
