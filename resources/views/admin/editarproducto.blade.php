...
<body class="text-white">
    ...
    <main class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="bg-gray-800 rounded-lg shadow-lg p-8">
            ...
            <form action="{{ url('/admin/editarproducto') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-4">
                    <label for="compania" class="block text-gray-300 font-semibold mb-2">Compañia *</label>
                ...
                <div class="mb-4">
                    <label for="descripcion" class="block text-gray-300 font-semibold mb-2">Descripcion *</label>
                ...
                <div class="flex gap-4">
                    ...
                    <a href={{ url('/admin/' . strtolower($producto->tipo)) . 's'}} class="flex-1 bg-gray-600 hover:bg-gray-500 text-white font-semibold py-3 rounded transition duration-300 text-center">
                        ❌ Cancelar
                    </a>
                </div>
            </form>
